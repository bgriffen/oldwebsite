...
<li><strong>Location:</strong> Cambridge, Massachusetts, USA</li> 
...
<img src="/assets/pages/profile.jpg" alt="Brendan Griffen" style="float: center; width: 100%; margin-left: 0%; margin-bottom: 0%">
